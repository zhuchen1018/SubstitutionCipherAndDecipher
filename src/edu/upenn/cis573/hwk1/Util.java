...
public class Util {
    ...
    public static void compareAndCount(String originalText,
            String decryptedText, String Filename) {
        long count = 0;
        long correctCount = 0;
    ...
    private static void printSingleRes(String filename, long count,
            long correctCount) {
